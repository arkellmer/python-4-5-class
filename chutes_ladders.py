...
#  File "C:/Users/andrew.kellmer/Desktop/Python/chutes_ladders.py", line 259, in <module>
#    main()
#  File "C:/Users/andrew.kellmer/Desktop/Python/chutes_ladders.py", line 239, in main
#    player = Player(name,i+1)
#  File "C:/Users/andrew.kellmer/Desktop/Python/chutes_ladders.py", line 29, in __init__
...
class Player(object):
    ...
    def roll(self):
        die1 = random.randrange(DIE_LOW,DIE_HIGH)
        ###die2 = random.randrange(DIE_LOW,DIE_HIGH)
        roll = die1
...
class Board(object):
    ...
    def display_board(self):
        ...
        print("|50" + p1p[49] + p2p[49] + "  |49" + p1p[48] + p2p[48] + "  |48" + p1p[47] + p2p[47] + "  |47" + p1p[46] +
            p2p[46] + "  |46" + p1p[45] + p2p[45] + "  |45"+p1p[44]+p2p[44]+"  |44"+p1p[43]+p2p[43]+"  |43"+p1p[42]+p2p[42]+"  |42"+p1p[41]+p2p[41]+"  | 41"+p1p[40]+p2p[40]+"  | ")
...
def main():
    ...
    #runs the game in the while loop
    while not winner:
